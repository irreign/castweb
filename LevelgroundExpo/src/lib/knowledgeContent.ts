...
export const ARTICLES: KnowledgeItem[] = [
  {
  ...
  },
  {
    ...
    body: [
      'Why is the seller selling? How long has it been listed, and has the price changed? Have there been any disputes with neighbors or building management? Any unauthorized renovations?',
...
export function articleById(id: string): KnowledgeItem | undefined {
